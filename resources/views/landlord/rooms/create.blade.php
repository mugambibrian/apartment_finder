...
<div class="container">
    <div class="shadow mt-2 p-4">
        ...
        <div class="row mb-4">
            ...
            <div class="col-6">Apartment Name: {{$apartment->name}}</div>
            <div class="col-6">Location: {{$apartment->location}}</div>
            <div class="col-6">Current No of Rooms: {{$apartment->houses()->count()}}</div>
        </div>
        <form action="{{ route('rooms.store', $apartment->id) }}" enctype="multipart/form-data" method="post">
            @csrf
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-floating mb-3">
                        <input type="number" 
                            ...
                            value="@if(old('room_no')){{old('room_no')}}@endif">
                ...
                <div class="col-sm-12 col-md-6 mb-3">
                    <div class="form-floating">
                        <input type="number" 
                            ...
                            value="@if(old('bedrooms')){{old('bedrooms')}}@endif">
                ...
                <div class="col-sm-12 col-md-6 mb-3">
                    <div class="form-floating">
                        <input type="number" 
                            ...
                            value="@if(old('bathrooms')){{ old('bathrooms')}}@endif">
